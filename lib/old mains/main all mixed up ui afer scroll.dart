...
import 'package:flutter/services.dart' show rootBundle, SystemChrome, DeviceOrientation, MethodChannel, SystemUiMode, HapticFeedback;
...
class _ProfileSearchScreenState extends State<ProfileSearchScreen> {
  ...
  void _maybeTriggerHubHaptic() {
    final now = DateTime.now();
    if (_lastHubHapticAt == null || now.difference(_lastHubHapticAt!) > const Duration(milliseconds: 140)) {
      ...
      child: ListView(
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 6),
                Text('Swipe the list to browse the app. Tap any item to open that screen or tool.'),
              ],
            ),
          ),
          const SizedBox(height: 18),
          const Text('Main screens', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          _hubCard(
            icon: Icons.search,
            color: Colors.blue.shade700,
            title: 'Profile Finder',
            subtitle: 'Open the original finder screen with the profile search and measurement form.',
          ...
          _hubCard(
            ...
            color: Colors.blue.shade700,
            title: 'Tools',
            subtitle: 'Open all roofing tools in one place.',
            onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const ToolsScreen())),
          ),
          _hubCard(
            icon: Icons.history,
            color: Colors.indigo.shade700,
            title: 'History',
            subtitle: 'View your recently saved profiles and export them.',
          ...
          _hubCard(
            ...
            title: 'Saved',
            subtitle: 'Open your saved material lists and saved calculations.',
            onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const _SavedListsScreen())),
          ),
          _hubCard(
            icon: Icons.star,
            color: Colors.orange.shade700,
            title: 'Favorites',
            subtitle: 'See the profiles you marked as favourites.',
            onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const FavouritesScreen())),
          ),
          _hubCard(
            icon: Icons.help_outline,
            color: Colors.teal.shade700,
            title: 'How to Measure',
            subtitle: 'Quick guidance on taking measurements for profile matching.',
            onTap: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const HowToUseScreen())),
          ),
          const SizedBox(height: 8),
          const Text('Quick tools', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          _hubCard(
            icon: Icons.architecture,
            color: Colors.blue.shade700,
            title: 'Roof Pitch Finder',
            subtitle: 'Measure pitch in degrees and ratio.',
          ...
          _hubCard(
            ...
            color: Colors.green.shade700,
            title: 'Material List',
            subtitle: 'Build a takeoff list for the job.',
          ...
          _hubCard(
            ...
            color: Colors.indigo.shade700,
            title: 'Perimeter Area Tool',
            subtitle: 'Sketch a building outline and work out area.',
          ...
          _hubCard(
            ...
            subtitle: 'Calculate rafter length, ridge height and quantities.',
          ...
          _hubCard(
            ...
            title: 'Suggest / Add Profile',
            subtitle: 'Send details of a profile you want added.',
            onTap: _showSuggestProfileDialog,
          ),
          _hubCard(
            icon: Icons.info_outline,
            color: Colors.blueGrey.shade700,
            title: 'About',
            subtitle: 'Read about the app and what it does.',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Column(children: [
              ...
              SizedBox(
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                  // Left: donate + account
                  IconButton(tooltip: 'Donate', onPressed: _openDonate,
                  ...
                  IconButton(
                    ...
                    icon: Icon(
                      ...
                      size: 22, color: AuthService.isLoggedIn ? Colors.greenAccent : Colors.white),
                  ),
                  // Centre: app name
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                      const Text('ROOF PROFILE & TILE FINDER',
                        style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: 0.5)),
                      const SizedBox(height: 2),
                      Text('700+ sheets  •  100+ tiles & slates',
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _quickChip(Icons.star, 'Favourites', const Color(0xFFE65100), () => _handleTopMenu('favourites')),
                    _quickChip(Icons.picture_as_pdf, 'PDF Export', const Color(0xFFC62828),
                      () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (_) => const HistoryScreen()))),
                  ],
                ),
              ),
      ...
      body: widget.homeHubMode ? _buildHomeHubBody() : _buildFinderFormBody(),
    );
  }
}
